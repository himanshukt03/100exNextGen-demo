         ...
         <div className="container">
            <div className="row gutter-y-30" style={{ paddingBottom: "60px", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
               ...
               <div className="col-lg-2 col-md-6">
                  ...
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "12px" }}>
                     {[{ label: "Insights", href: "/#insights" }, { label: "Contact", href: "/#contact" }].map((item, i) => (
                        <li key={i}><Link href={item.href} style={{ fontSize: "14px", color: "rgba(255,255,255,0.45)", textDecoration: "none", transition: "color 0.3s" }}>{item.label}</Link></li>
                     ))}
                  </ul>
               </div>
               <div className="col-lg-3 col-md-6">
                  ...
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "12px" }}>
                     <li style={{ fontSize: "14px", color: "rgba(255,255,255,0.45)" }}>hello@100exnextgen.com</li>
            ...
            <div style={{ padding: "24px 0", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
               ...
               <div style={{ display: "flex", gap: "24px" }}>
                  {["Privacy Policy", "Terms of Service"].map((item, i) => (
                     <Link key={i} href="/contact" style={{ fontSize: "13px", color: "rgba(255,255,255,0.35)", textDecoration: "none", transition: "color 0.3s" }}>{item}</Link>
                  ))}
               </div>
            </div>
         </div>
