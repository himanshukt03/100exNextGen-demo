         ...
         <div className="container">
            <div className="row align-items-end" style={{ marginBottom: "48px" }}>
               ...
               <div className="col-lg-4 text-lg-end">
                  <Link href="/blog" style={{ fontSize: "14px", fontWeight: 600, color: "var(--tg-theme-primary)", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "6px" }}>
                     View All Insights
            ...
            <div className="row gutter-y-30 justify-content-center">
               {[
                  { id: 1, num: "01", source: "World Bank Group", title: "Global Economic Prospects", color: "#1565C0" },
                  { id: 2, num: "02", source: "Harvard Business Review", title: "Research: When Should Startups Scale?", color: "#0047FF" },
                  { id: 3, num: "03", source: "Knowledge at Wharton", title: "Why the Most Successful Companies Are Scalable", color: "#2E7D32" },
               ].map((item) => (
                  <div key={item.id} className="col-lg-4 col-md-6">
                     <div className="insight-card" style={{
                        ...
                        <Link href="/blog-details" style={{ fontSize: "14px", fontWeight: 600, color: "var(--tg-theme-primary)", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "6px" }}>
                           Read More
